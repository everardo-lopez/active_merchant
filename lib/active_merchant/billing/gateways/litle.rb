  ...
  module Billing #:nodoc:
    class LitleGateway < Gateway
      ...
      def check?(payment_method)
        return false if payment_method.is_a?(String) || payment_method.is_a?(Numeric)
      ...
      def add_payment_method(doc, payment_method, options)
        if payment_method.is_a?(String) || payment_method.is_a?(Numeric)
          doc.token do
      ...
      def add_billing_address(doc, payment_method, options)
        return if payment_method.is_a?(String) || payment_method.is_a?(Numeric)
